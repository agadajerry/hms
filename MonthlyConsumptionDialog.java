...
public class MonthlyConsumptionDialog extends JDialog {
	...
	public MonthlyConsumptionDialog() {
		setLayout(new BorderLayout(8,8));
		setBackground(Color.WHITE);

		this.setTitle("Patient Drug Consumption");
		...
		JLabel northLabel = new JLabel("<html><body><div>"
				...
				+ ""
				+ "</h2><hr/><span style=color:red>PATIENTS MONTHLY DRUG CONSUMPTION</span></div></body></html>"
				);
		
		northLabel.setFont(new Font("Aharoni",Font.BOLD,18));
		JLabel northIconLabel = new JLabel("Consumption Rate|",northBgIcon,JLabel.CENTER);
...
//
		...
		//
		JPanel patientTablePanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
		patientTablePanel.setPreferredSize(new Dimension(1210, 110));
