...
public class LoginDialogPhar extends JDialog {
	...
	public LoginDialogPhar(String adminText) {
	...
	private class LoginListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				if (login(userField.getText().toLowerCase(), passW)&& loginAs.getText().substring(10).equals("Pharmacist")) {
